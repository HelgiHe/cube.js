...
require('core-js/es/number/constructor');
require('core-js/es/number/parse-float');
// require('core-js/web.dom.iterable');
...
require('core-js/es/array/reduce');
require('core-js/es/array/index-of');
...
require('core-js/es/regexp/split');
require('core-js/es/function/name');
require('core-js/es/regexp/to-string');
require('core-js/es/date/to-string');
